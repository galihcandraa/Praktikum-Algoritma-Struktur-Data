...
public class View10 {
    ...
    public void tambahAntriPembeli(Scanner sc, AntrianPembeli10 antrian) {
        ...
        // Antrian prioritas
        System.out.print("Apakah antrian prioritas? (y/n): ");
        String prioritas = sc.nextLine();
        
        Pembeli10 pembeli;
        if (prioritas.equalsIgnoreCase("y")) {
            pembeli = new Pembeli10(noAntri, nmPembeli, no, true);
            antrian.addLast(pembeli, true);
        } else {
            pembeli = new Pembeli10(noAntri, nmPembeli, no, false);
            antrian.addLast(pembeli, false);
        }
        
        System.out.println("Antrian berhasil ditambahkan dengan nomor: " + pembeli.noAntri + "\n");
        noAntri++;
    }
